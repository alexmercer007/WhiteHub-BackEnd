...
package com.red.whitehub.entity.archive;
...
public class ArchivedUser {
    ...
    @Column(name = "archived_reason_code")
    private String archivedReasonCode;

    @Column(name = "archived_source")
    private String archivedSource; // USER, SYSTEM, ADMIN, LEGAL

    @Column(name = "hash_integrity")
    private String hashIntegrity; // detectar manipulación
